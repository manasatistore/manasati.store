...
def init_sqlite_db():
    ...
    if cursor.fetchone()[0] == 0:
        initial_products = [
            ...
            ("اشتراك STARZPLAY MAX (حساب كامل خاص بك)", "entertainment", 35.00, 65.00, "حساب كامل 🔒", "شهر واحد", "تسليم فوري ⚡", "https://images.unsplash.com/photo-1578022761797-b8636ac1773c?w=500&auto=format&fit=crop&q=80", "حساب كامل خاص بك على تطبيق ستارش بلاي STARZPLAY MAX لمشاهدة أقوى المسلسلات والأفلام والرياضة المباشرة بدون إعلانات."),
            ("اشتراك STARZPLAY MAX (ملف خاص بك)", "entertainment", 15.00, 30.00, "توفير بلس 💡", "شهر واحد", "تسليم فوري ⚡", "https://images.unsplash.com/photo-1578022761797-b8636ac1773c?w=500&auto=format&fit=crop&q=80", "بروفايل شخصي خاص بك داخل حساب STARZPLAY MAX، مشاهدة غير محدودة لأحدث الأفلام والمسلسلات وجودة عالية HD."),
            ...
            ("اشتراك مايكروسوفت أوفيس 365 (تفعيل رسمي 1 تيرابايت)", "ai", 25.00, 60.00, "توفير أعمال 💼", "سنة كاملة", "تفعيل فوري ⚡", "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=500&auto=format&fit=crop&q=80", "حزمة برامج Office الكاملة (Word, Excel, PowerPoint, Outlook) مع مساحة سحابية 1 Terabyte على OneDrive لتخزين ملفاتك بأمان.")
        ]
